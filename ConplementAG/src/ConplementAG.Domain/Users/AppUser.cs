...
namespace ConplementAG.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ConplementAGDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ConplementAGEfCoreEntityExtensionMappings to extend the IdentityUser entity
